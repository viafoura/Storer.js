...
*/function initStorer(a,b){function c(a,b){var c={STORE_TYPE:"ref"+a,key:function(a){return b.key(a)},getItem:function(a){return b.getItem(a)},setItem:function(a,c){return b.setItem(a,c)},removeItem:function(a){return b.removeItem(a)},clear:function(){return b.clear()}};return Object.defineProperty(c,"length",{get:function(){return b.length}}),c}function d(a,b){var c=document.createElement("div");return c.STORE_TYPE="DOM"+a,c.key=b.key,c.getItem=b.getItem,c.setItem=b.setItem,c.removeItem=b.removeItem,c.clear=b.clear,Object.defineProperty(c,"length",{get:function(){return b.length}}),c}function e(a){a=(a||"")+n;var c=new RegExp("(?:^|;)s*"+a+"[^=]+s*=[^;]*","g"),d=new RegExp("^;?s*"+a),e=new RegExp("(?:^|;)s*[^=]+s*=[^;]*","g"),g=new RegExp("^;?s*"),h=new Date(1979).toGMTString(),i={STORE_TYPE:"cookieStorage",DEFAULT_DOMAIN:escape(b.default_domain||""),DEFAULT_PATH:escape(b.default_path||""),getAll:function(a,b){var f,h=b?g:d,i=document.cookie.match(b?e:c)||[],j=i.length;if(a===!0)for(f={length:j};j--;)f[unescape((i[j]=i[j].split("="))[0].replace(h,""))]=i[j][1];else for(f=[];j--;)f.push({key:unescape((i[j]=i[j].split("="))[0].replace(h,"")),value:i[j][1]});return f},getItem:function(b,c){return b&&this.hasItem(b,c)?(c=document.cookie.match(new RegExp("(?:^|;) *"+escape((c?"":a)+b)+"=([^;]*)(?:;|$)")),c&&c[0]?unescape(c[1]):null):null},setItem:function(b,c,d,e,f,g,h){if(!b||"expires"===b||"max-age"===b||"path"===b||"domain"===b||"secure"===b)return!1;var j="";if(d)switch(typeof d){case"number":j="; max-age="+d;break;case"string":j="; expires="+d;break;case"object":d.hasOwnProperty("toGMTString")&&(j="; expires="+d.toGMTString())}return void 0!==c&&null!==c?(f=(f="string"==typeof f?escape(f):i.DEFAULT_DOMAIN)?"; domain="+f:"",e=(e="string"==typeof e?escape(e):i.DEFAULT_PATH)?"; path="+e:"",document.cookie=escape((h?"":a)+b)+"="+escape(c)+j+f+e+(g?"; secure":""),!0):i.removeItem(b,f,e,g,h)},removeItem:function(b,c,d,e,f){return b&&this.hasItem(b,f)?(c=(c="string"==typeof c?escape(c):i.DEFAULT_DOMAIN)?"; domain="+c:"",d=(d="string"==typeof d?escape(d):i.DEFAULT_PATH)?"; path="+d:"",document.cookie=escape((f?"":a)+b)+"=; expires="+h+c+d+(e?"; secure":""),!0):!1},hasItem:function(b,c){return new RegExp("(?:^|;) *"+escape((c?"":a)+b)+"=").test(document.cookie)}};return i.setItem(l,4),4==i.getItem(l)?(i.removeItem(l),i):f()}function f(){var a={},b=[],c={},d={STORE_TYPE:"memoryStorage",length:0,key:function(a){return b[a]},getItem:function(b){return a[b]},setItem:function(e,f){return null!==f&&void 0!==f?(void 0===c[e]&&(c[e]=(d.length=b.push(e))-1),a[e]=f):d.removeItem(e)},removeItem:function(e){var f=void 0!==a[e];if(void 0!==c[e]){for(var g=b.length;--g>c[e];)c[b[g]]--;b.splice(c[e],1),delete c[e]}return delete a[e],d.length=b.length,f},clear:function(){for(var e in a)a.hasOwnProperty(e)&&delete a[e];d.length=b.length=0,c={}}};return d}function g(a){function b(){var b=a.name,c=b.indexOf(k),f=b.indexOf(l),g=w.length;for(c>-1&&f>c&&(a.name=b.slice(0,c)+b.slice(f+s)),b="";g--;)v[w[g]]&&v[w[g]].value&&(b+=n+(""+w[g]).length+":"+(""+v[w[g]].value).length+o+w[g]+o+v[w[g]].value+p);a.name+=k+encodeURI(e.encode(d,b))+l}function c(){var c=a.name,f=c.indexOf(k),g=c.indexOf(l),h=0,i="",j=0,m=0;if(f>-1&&g>f)for(a.name=c.slice(0,f)+c.slice(g+s),c=e.decode(d,decodeURI(c.slice(f+r,g)));-1!==(f=c.indexOf(n,h));)h=f+t,-1!==(g=c.indexOf(o,h))&&(j=c.slice(h,g).split(":"),m=parseInt(j[1],10),j=parseInt(j[0],10),h=g+u,(g=c.indexOf(o,h))===h+j&&(i=c.substr(h,j),h=g+u,(g=c.indexOf(p,h))===h+m&&x.setItem(i,c.substr(h,m))));a.addEventListener?a.addEventListener("beforeunload",b,!0):a.attachEvent&&a.attachEvent("onbeforeunload",b)}a||(a=m);var d,e=function(a,b,c){return{decode:function(a,b){return this.encode(a,b)},encode:function(c,d){for(var e,f=c.length,g=d.length,h=[],i=[],j=0,k=0,l=0,m=0;256>j;j++)i[j]=j;for(j=0;256>j;j++)k=(k+(e=i[j])+c.charCodeAt(j%f))%256,i[j]=i[k],i[k]=e;for(k=0;g>l;l++)j=l%256,k=(k+(e=i[j]))%256,f=i[j]=i[k],i[k]=e,h[m++]=d.charCodeAt(l)^i[(f+e)%256];return b.apply(a,h)},key:function(d){for(var e=0,f=[];d>e;e++)f[e]=1+(255*c()<<0);return b.apply(a,f)}}}(String,String.fromCharCode,Math.random),f="[object Opera]"===Object.prototype.toString.call(window.opera);try{d=decodeURI(h.getItem(".sessionStorageKey"))}catch(g){}d&&d.length===q||(d=e.key(q),h.setItem(".sessionStorageKey",encodeURI(d)));var i=a.document.domain,j=e.encode(d,i),k="#"+String.fromCharCode(1)+"STOR/"+j,l=j+"/STOR"+String.fromCharCode(4)+"#",n=String.fromCharCode(2)+";",o=String.fromCharCode(23)+";",p=";"+String.fromCharCode(3),q=32,r=k.length,s=l.length,t=n.length,u=o.length,v=(p.length,{}),w=[],x={STORE_TYPE:"name",length:0,key:function(a){return w[a]},getItem:function(a){return v[a]?v[a].value:null},setItem:function(a,c){return v[a]?v[a].value=c:v[a]={value:c,index:(x.length=w.push(a))-1},f&&b(),c},removeItem:function(a){if(v[a]){if(w[v[a].index]===a){w.splice(v[a].index,1),x.length=w.length;for(var c=v[a].index,d=w.length;d>c;c++)v[w[c]].index--}return delete v[a],f&&b(),!0}return!1},clear:function(){w.length=0,v={},f&&b()}};try{c()}catch(g){}return x}var h,i,j,k,l="__SG__",m=window,n=(b=b||{}).prefix||"",o=!0;try{for(;m!==m.top;)m=m.top}catch(p){}var q={cookieStorage:null,localStorage:null,memoryStorage:null,sessionStorage:null,_createCookieStorage:e,_createMemoryStorage:f};return q.cookieStorage=h=e(),q.memoryStorage=j=f(),q.sessionStorage=k=function(){var a=m.sessionStorage;if(a)try{a.setItem(l,1),a.removeItem(l);var b=function(){};b.prototype=a,b=new b;try{b.getItem&&(b.setItem(l,2),b.removeItem(l))}catch(e){b=null}a=b&&!b.getItem?d("sessionstorage",a):b&&"[object StoragePrototype]"!==Object.prototype.toString.apply(Storage.prototype)?b:c("sessionstorage",a)}catch(e){a=null}if(!a){try{a=g(),a.setItem(l,2),2==a.getItem(l)?a.removeItem(l):a=null}catch(e){a=null}a||(a=f())}return a._getItem=a.getItem,a._setItem=a.setItem,a._removeItem=a.removeItem,a._key=a.key,a.getItem=function(b){return a._getItem(n+b)},a.setItem=function(b,c){return a._setItem(n+b,c)},a.removeItem=function(b){return a._removeItem(n+b)},a.key=function(b){return void 0!==(b=a._key(b))&&null!==b?0===b.indexOf(n)?b.substr(n.length):b:null},a.clear=function(){for(var b,c=a.length;c--;)0===(b=a._key(c)).indexOf(n)&&a._removeItem(b)},a}(),q.localStorage=i=function(){var b;if(m.localStorage||m.globalStorage)try{b=m.localStorage||m.globalStorage[location.hostname],b.setItem(l,1),b.removeItem(l);var f=function(){};f.prototype=b,f=new f;try{f.getItem&&(f.setItem(l,2),f.removeItem(l))}catch(g){f=null}b=f&&!f.getItem?d("localstorage",b):f&&"[object StoragePrototype]"!==Object.prototype.toString.apply(Storage.prototype)?f:c("localstorage",b)}catch(g){b=null}return b||(b=function(){var c=function(a){return"PS"+a.replace(d,"__").replace(f,"_s")},d=/_/g,f=/ /g,g=c(n+"uData"),h=c("Storer");if(window.ActiveXObject)try{var j={},k=[],m={},p={STORE_TYPE:"userData",length:0,key:function(a){return k[a]},getItem:function(a){return r.getAttribute(c(a))},setItem:function(a,b){return null!==b&&void 0!==b?(r.setAttribute(c(a),b),void 0===m[a]&&(m[a]=(p.length=k.push(a))-1),r.save(g+h),j[a]=b):p.removeItem(a)},removeItem:function(a){if(r.removeAttribute(c(a)),void 0!==m[a]){for(var b=k.length;--b>m[a];)m[k[b]]--;k.splice(m[a],1),delete m[a]}return r.save(g+h),p.length=k.length,!0},clear:function(){for(var a,b=r.xmlDocument,c=b.firstChild.attributes,d=c.length;0<=--d;)a=c[d],delete j[a.nodeName],r.removeAttribute(a.nodeName),p.length--;r.save(g+h),p.length=k.length=0,j={},m={}}},r=document.createElement("input");r.style.display="none",r.addBehavior("#default#userData");var s="function"==typeof domReady?domReady:"undefined"!=typeof jQuery?jQuery(document).ready:!1;return o=!s,s&&s(function(){try{var c=document.body||document.getElementsByTagName("head")[0];if(c.appendChild(r),r.load(g+h),p.setItem(l,3),3==p.getItem(l)){p.removeItem(l);for(var d,f=r.xmlDocument,n=f.firstChild.attributes,o=-1,s=n.length;++o<s;)d=n[o],void 0!==d.nodeValue&&null!==d.nodeValue&&(m[d.nodeName]=k.push(d.nodeName)-1,j[d.nodeName]=d.nodeValue);q.localStorage=i=p,a&&a(q)}else p=null}catch(t){p=null}p||(q.localStorage=i=b=e(),a&&a(q))}),p}catch(t){}}()),b||(b=e()),n?(b._getItem=b.getItem,b._setItem=b.setItem,b._removeItem=b.removeItem,b._key=b.key,b.getItem=function(a){return b._getItem(n+a)},b.setItem=function(a,c){return b._setItem(n+a,c)},b.removeItem=function(a){return b._removeItem(n+a)},b.key=function(a){return void 0!==(a=b._key(a))&&null!==a?0===a.indexOf(n)?a.substr(n.length):a:null},b.clear=function(){for(var a,c=b.length;c--;)0===(a=b._key(c)).indexOf(n)&&b._removeItem(a)},b):b}(),o&&a&&a(q),q}